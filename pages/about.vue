				...
				div.about__detail
					...
					ul.about__detail--link
						li(v-for="(item, i) in link", :key="i")
							a(:href="item.url", target="page")
								figure
									svg(version="1.1", xmlns="http://www.w3.org/2000/svg", xmlns:xlink="http://www.w3.org/1999/xlink", x="0px", y="0px", viewBox="0 0 512 512", style="enable-background:new 0 0 448 512;", xml:space="preserve").about__detail--link--icon
										g
											path(v-for="(path) in item.path", :key="path" :d="path")
								| {{item.name}}
				div.about__icon
      ...
      link: [
        {
          ...
          path: [
            'M226.8,110.5c-64.4,0-116.3,51.9-116.3,116.3S162.5,343,226.8,343s116.3-51.9,116.3-116.3S291.2,110.5,226.8,110.5zM226.8,302.4c-41.6,0-75.6-33.9-75.6-75.6s33.9-75.6,75.6-75.6s75.6,33.9,75.6,75.6S268.4,302.4,226.8,302.4L226.8,302.4zM375,105.8c0,15.1-12.1,27.1-27.1,27.1c-15.1,0-27.1-12.1-27.1-27.1s12.1-27.1,27.1-27.1S375,90.8,375,105.8z M451.9,133.3c-1.7-36.3-10-68.5-36.6-95c-26.5-26.5-58.7-34.8-95-36.6c-37.4-2.1-149.6-2.1-187.1,0c-36.2,1.7-68.4,10-95,36.5s-34.8,58.7-36.6,95c-2.1,37.4-2.1,149.6,0,187.1c1.7,36.3,10,68.5,36.6,95s58.7,34.8,95,36.6c37.4,2.1,149.6,2.1,187.1,0c36.3-1.7,68.5-10,95-36.6c26.5-26.5,34.8-58.7,36.6-95C454.1,282.8,454.1,170.7,451.9,133.3L451.9,133.3z M403.6,360.4c-7.9,19.8-23.2,35.1-43.1,43.1c-29.8,11.8-100.7,9.1-133.7,9.1s-103.9,2.6-133.7-9.1c-19.8-7.9-35.1-23.2-43.1-43.1C38.2,330.6,41,259.8,41,226.8s-2.6-103.9,9.1-133.7C58,73.3,73.2,58,93.2,50c29.8-11.8,100.7-9.1,133.7-9.1s103.9-2.6,133.7,9.1c19.8,7.9,35.1,23.2,43.1,43.1c11.8,29.8,9.1,100.7,9.1,133.7S415.4,330.7,403.6,360.4z',
          ],
        },
        // {
        //   name: 'mail',
